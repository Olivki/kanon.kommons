...
public class AttributeMap @PublishedApi internal constructor(private val parent: Element) : MutableMap<String, String> {
     ...
     * @since DOM Level 2
     */
    public operator fun contains(key: String): Boolean = containsKey(key)
     ...
     * @since DOM Level 2
     */
    public operator fun set(namespaceURI: String, qualifiedName: String?, value: String) {
     ...
     * @since DOM Level 2
     */
    public operator fun minusAssign(nsAttr: Pair<String?, String>) {
     ...
     * @since DOM Level 2
     */
    public operator fun get(namespaceURI: String?, localName: String): String =
     ...
     * @since DOM Level 2
     */
    public operator fun contains(attrPair: Pair<String?, String>): Boolean =
     ...
     * @since DOM Level 3
     */
    public operator fun set(name: String, isId: Boolean) {
     ...
     * @since DOM Level 3
     */
    public operator fun set(namespaceURI: String, localName: String, isId: Boolean) {
