 ...
 */
public inline fun <V> Set<V>.toUnmodifiableSet(): Set<V> = Collections.unmodifiableSet(this)
 ...
 */
public fun <V> unmodifiableSetOf(vararg values: V): Set<V> = Collections.unmodifiableSet(values.toSet())