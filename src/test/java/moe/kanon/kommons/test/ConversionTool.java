...
/**
 * A utility class to convert the parent properties into any type.
 *
...
public final class ConversionTool {
    /**
     * Constant for the events delimiter as char.
     */
    static final char LIST_ESC_CHAR = '\\';

    /**
     * Constant for the events delimiter escaping character as string.
     */
    ...
    public static Object to(final Class<?> cls, final Object value,
                            final Object[] params) throws ConversionException {
     ...
     * converts the passed in object to a string. If the string contains exactly one
     ...
     */
    public static Locale toLocale(final Object value)
            throws ConversionException {
     ...
     * commons-lang contains a better replacement available (Tokenizer?).
     * <p>
     ...
     * @return a events with the single tokens
     */
    public static List<String> split(final String s, final char delimiter,
                                     final boolean trim) {
        if (s == null) {
        ...
        while (begin < s.length()) {
            ...
            if (inEscape) {
                ...
                if (c == delimiter) {
                    // found a events delimiter -> add token and
    ...
    public static Color toColor(final Object value) throws ConversionException {
        if (value instanceof Color) {
            return (Color) value;
                ...
                && !StringsKt.isBlank((String) value)) {
     ...
     * @since 1.5
     */
    static InetAddress toInetAddress(final Object value)
            throws ConversionException {
     ...
     * @since 1.5
     */
    static Object toInternetAddress(final Object value)
            throws ConversionException {
     ...
     * @since 1.5
     */
    static <E extends Enum<E>> E toEnum(final Object value, final Class<E> cls)
            throws ConversionException {
     ...
     */
    public static Date toDate(final Object value, final String format)
            throws ConversionException {
     ...
     * @throws ConversionException thrown if the value cannot be converted to a Calendar
     */
    public static Calendar toCalendar(final Object value, final String format)
            throws ConversionException {
     ...
     * <ul>
     * <li>Strings are checked for delimiter character and split if necessary.</li>
     ...
     * primitive objects (hence the fileName &quot;flatten&quot;).</li>
     * </ul>
     *
     ...
     */
    private static Collection<?> flatten(final Object value,
                                         final char delimiter) {
    ...
    private static void flattenIterator(final Collection<Object> target,
                                        final Iterator<?> it, final char delimiter) {
        while (it.hasNext()) {
    ...
    private static Object convertToEnum(final Class enumClass, final Object value) {
        ...
        try {
            tempEnum = toEnum(value, enumClass.asSubclass(Enum.class));
